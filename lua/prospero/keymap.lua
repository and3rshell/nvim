...
vim.keymap.set("n", "<leader>pc", ":edit app/Controllers/<C-r><C-w>.php<Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left><Left>")
